        ...
        <>
            <footer className="bg-white dark:bg-gray-900">
                <div className="  px-8 py-6 mx-auto">
                    <div className="lg:flex">
                        <div className="w-full -mx-6 lg:w-2/5">
                            <div className="px-6">
                                ...
                                <p className="text-xl font-semibold">Student Scholarship</p>
                    ...
                    <div>
                        <p className="text-center text-gray-500 dark:text-gray-400">© Student Scholarship 2024 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </>
