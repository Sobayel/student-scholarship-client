    ...
    return (
        <div className="w-full max-w-sm p-6 m-auto mx-auto my-5 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <div className="flex justify-center mx-auto">
                <img className="w-16 h-12 rounded-xl" src={logo} alt="Logo" />
            </div>
            ...
            <form onSubmit={handleSubmit(handleSignUp)} className="mt-6">
                ...
                <div className="mt-4">
                    ...
                    />
                    {errors.password && <span className="text-red-700">This field is required and must be at least 6 characters...</span>}
                </div>
                {registerError && <p className="text-red-700 text-sm">{registerError}</p>}
